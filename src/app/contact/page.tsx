...
export default function Home() {
    ...
    return (
        <main>
            ...
            <header className="p-8 grid grid-cols-1 md:grid-cols-2 gap-4 pt-10 lg:px-40 bg-[#111111]/30 md:h-96 md:px-8">
                <div className="mx-auto mb-10 md:mt-20">
                    ...
                    <p className="text-sm text-gray-200 mt-4 font-light ">
                        ...
                        can. Alternatively, You can reach out to us at our email address.
                    </p>
                </div>
                <form
                ...
                >
                    ...
                    <label
                        htmlFor="fullname"
                        className=" font-light mt-8 text-gray-50"
                    >
                    ...
                    <label
                        htmlFor="email"
                        className=" font-light mt-4 text-gray-50"
                    >
            ...
            <section className="">
                <h1
                    className={`text-4xl font-bold text-center md:mt-60 my-10 gradient-text text-gray-50 ${errors ? "md:mt-80" : "md:mt-60"
                        }`}
                >
                    Reach out
                </h1>
